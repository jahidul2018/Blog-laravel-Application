    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <p class="login-box-msg">Sign in to start your session As a Editor</p>
                @if(Session::has('msg'))
                <p class="alert alert-danger">{{Session::get('msg')}}</p>
                @endif
                <form action="{{ route('editor.login.submit') }}" method="POST" role="form">
                    {{ csrf_field() }}
                ...
                <a href="{{ route('editor.password.request') }}">I forgot my password</a><br>
